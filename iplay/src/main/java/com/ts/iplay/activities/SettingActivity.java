...
import com.ts.iplay.utils.DataCleanManager;
...
//        version.setText(VersionUtils.getVersion(this));
        ...
        settingToolbar.setNavigationIcon(getResources().getDrawable(R.mipmap.abc_ic_ab_back_mtrl_am_alpha));
        mTvCache.setText(DataCleanManager.getTotalCacheSize(this));
        mToast = Toast.makeText(this, "", Toast.LENGTH_SHORT);
    }

    //点击事件
    @OnClick({R.id.setting_iv_clearCache, R.id.setting_iv_version, R.id.setting_iv_heart, R.id.setting_iv_about,R.id.setting_iv_exit})
...
//                startActivity(intent);
            ...
            case R.id.setting_iv_about://关于
                ...
                startActivity(about);
                break;
            case R.id.setting_iv_exit://退出账号
                break;
        }
    }
